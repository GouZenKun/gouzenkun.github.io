...
export const metadata: Metadata = {
  title: "Thanakit Gowitwanich | Premium Creative Engineer & Graphic Programmer Portfolio",
  ...
  authors: [{ name: "Thanakit Gowitwanich" }],
  openGraph: {
    title: "Thanakit Gowitwanich | Premium Creative Engineer & Graphic Programmer Portfolio",
    ...
    siteName: "Thanakit Gowitwanich Portfolio",
    locale: "en_US",
    type: "website",
  },
};
